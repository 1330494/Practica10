  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Modo: Tutor</a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">          
              ...
              <li class="nav-item">
                <a href="index.php?action=tutorados" class="nav-link">
                  <i class="nav-icon fa fa-group text-success"></i>
                  <p>Tutorados</p>
                </a>
              </li>

              <li class="nav-item">
                <a href="index.php?action=registro-tutoria" class="nav-link">

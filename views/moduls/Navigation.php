  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="dist/img/tutoria.png" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block">School System</a>
        </div>
      </div>
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="index.php?action=ingresar" class="nav-link">
                  <i class="nav-icon fa fa-edit text-success"></i>
                  <p>Inicio</p>
                </a>
              </li>
